...
The dashboard provides a centralized view of sales performance, target achievement, customer distribution, revenue trends, and regional insights. It enables stakeholders to monitor business performance and make data-driven decisions.

---

## Business Problem

The organization needed a reporting solution to:
...
- Optimized the data model for reporting and analysis
...
![Customer & Revenue Insights](Customer_and_revenue_insights.png)
...
- Order Source Distribution Analysis

---

### 2️⃣ Sales Team Performance Analysis

![Sales Team Performance](Sales_team.png)
...
- Revenue patterns highlighted opportunities for targeted sales campaigns.

### 🌍 Customer Analysis

- Customer concentration was higher in selected geographic regions.
- Order values varied significantly across countries.
- Customer distribution revealed key growth markets.
...
- Category-level analysis helped identify high-performing segments.
...
- Digital channels played a significant role in overall sales generation.
...
Aspiring Data Analyst with hands-on experience in SQL, Excel, Power BI, and Python. Passionate about transforming raw data into actionable business insights through analytics and visualization.
